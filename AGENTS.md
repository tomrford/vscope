...
Eventually make serial scheduling priority-aware so status/frame requests can interleave with slow snapshot downloads instead of waiting behind the whole data transfer.
